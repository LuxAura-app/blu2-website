 ...
 * @param {Array<{name: string, qty: number, unitPriceCents: number, provider: string, sku?: string, groupId?: string, size?: string|null}>} record.items
 *   sku/groupId/size are what `api/admin/presale-tally.js` sums by once a
 *   presale campaign closes — see docs/reporting.md.
